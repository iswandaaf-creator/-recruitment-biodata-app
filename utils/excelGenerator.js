...
async function generateExcel(candidates) {
  ...
  summarySheet.columns = [
    ...
    { header: 'Nomor KK', key: 'nomor_kk', width: 20 },
    { header: 'No. Rekening', key: 'no_rekening', width: 20 },
    { header: 'Gaji Pokok', key: 'gaji_pokok', width: 18 },
    { header: 'Produktivitas', key: 'produktivitas', width: 18 },
    { header: 'Tgl Join', key: 'tgl_join', width: 15 },
    { header: 'Tgl Resign', key: 'tgl_resign', width: 15 },
  ...
  candidates.forEach(c => {
    summarySheet.addRow({
      ...
      produktivitas: c.produktivitas || '',
      tgl_join: c.tgl_join || '',
      tgl_resign: c.tgl_resign || '',
  ...
  const detailColumns = [
    ...
    { header: 'Nomor KK', key: 'nomor_kk', width: 20 },
    { header: 'No Rekening Bank', key: 'no_rekening', width: 22 },
    { header: 'Gaji Pokok', key: 'gaji_pokok', width: 18 },
    { header: 'Produktivitas', key: 'produktivitas', width: 18 },
    { header: 'Tgl Join', key: 'tgl_join', width: 15 },
    { header: 'Tgl Resign', key: 'tgl_resign', width: 15 },
